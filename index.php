...
<html lang="en">
  ...
  <head>
    ...
    <title>Café5 | Kavárna v srdci Prahy</title>
    <meta name="description" content="Kavárna v srdci Prahy" />
  ...
  <body id="home">
  	...
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/">Café 5</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#hours" class="nav-link">Opening hours</a></li>
	          <li class="nav-item"><a href="#contact" class="nav-link">Career</a></li>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url(images/slider/cafe5_brunch.jpg);">
...
$menu = new cafe5_parse_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vTyxX6qhe-1ZK1aQAEvBfbZyNE2KNWh9WChr8GL2u9RbqcigCkXzsJ8XU6ygV3bz0iBMnnrl6ofvFCR/pub?gid=0&single=true&output=csv");
echo $menu->showMenu();
?>
...
$menu = new cafe5_parse_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vTyxX6qhe-1ZK1aQAEvBfbZyNE2KNWh9WChr8GL2u9RbqcigCkXzsJ8XU6ygV3bz0iBMnnrl6ofvFCR/pub?gid=1975177027&single=true&output=csv");
echo $menu->showMenu();
